...
internal class NMSPacket20 : NMSPacket {
    /**
     * 创建实体生成数据包
     *
    ...
    override fun createBlockChange(data: PacketData): Any {
        ...
        return PacketPlayOutMultiBlockChange(SectionPosition.of(location), ShortSets.EMPTY_SET, null)
    }
    ...
    override fun createBossBar(data: PacketData): Any {
        ...
        return when (data.read<String>("action")) {
            ...
            "properties" -> {
                data.bind(boss).readNotNull<Boolean>("darkenScreen") {
                    setDarkenScreen(it)
                }.readNotNull<Boolean>("playMusic") {
                    setPlayBossMusic(it)
                }.readNotNull<Boolean>("createWorldFog") {
    ...
    override fun createNamedSoundEffect(data: PacketData): Any {
        ...
        val soundEffect = SoundEffect.createVariableRangeEvent(MinecraftKey.tryBuild(pluginId, "entity_sound_$sound"))
